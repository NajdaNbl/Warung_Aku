...
<body class="font-sans bg-[#FAF5EB] text-[#1F2937]">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="text-center max-w-lg">
            <h1 class="text-8xl font-extrabold text-[#1B4332] mb-4">404</h1>
            <div class="w-20 h-1 bg-[#D4A373] mx-auto mb-6"></div>
            <h2 class="text-2xl font-bold text-gray-700 mb-4">Halaman Tidak Ditemukan</h2>
            <p class="text-gray-500 mb-8">Maaf, halaman yang Anda cari tidak ditemukan atau telah dipindahkan.</p>
